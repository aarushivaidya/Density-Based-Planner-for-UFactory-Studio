...
# ============================================================
x0 = np.array([100.0, -600.0, 200.0])   # mm
xg = np.array([400.0,  0.0, 630.0])   # mm
...
for i in range(len(waypoints)):
    moveRobot(waypoints[i, 0], waypoints[i, 1], waypoints[i, 2], arm)

save_waypoints_to_file(waypoints, "twocylinderobstaclewaypoints.txt")
